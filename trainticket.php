...
<body id="home" class="scrollspy">
  ...
  <section class="slider">
    <ul class="slides">
      <li>
        <img src="https://getwallpapers.com/wallpaper/full/7/2/c/768446-train-desktop-wallpaper-1920x1080-ipad-retina.jpg">
        <!-- random image -->
      ...
      <li>
        <img src="http://1.bp.blogspot.com/-WMVVI7m8v2U/VN3hmiAwD7I/AAAAAAAAA6U/unTqck9cazo/s1600/Train-3.jpg">
        <!-- random image -->
      ...
      <li>
        <img src="https://getwallpapers.com/wallpaper/full/4/9/2/768341-train-desktop-wallpaper-1920x1080-for-4k.jpg">
        <!-- random image -->
        ...
        <tbody>
            ...
            if ($query->num_rows > 0) {
              # code...
                ...
                <td>".$air["train_name"]."</td>
                <td>".$air["train_number"]."</td>
                <td>".$air["ticket_number"]."</td>
                <td>".$air["seat_number"]."</td>
                <td>".$air["class"]."</td>
                <td>".$air["type"]."</td>
                <td>".$air["boarding_time"]."</td>
                <td>".$air["departure_time"]."</td>
                <td>".$air["amount"]."</td>
				<td>" ?><a href="train.php"><button class="fly" onclick="return payment()" ><i class="fa fa-train" aria-hidden="true"></i></button></a><?php "</td>
            </tr>";
...
<footer class="ftco-footer ftco-bg-dark ftco-section">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This web-site is made by <i class="icon-heart" aria-hidden="true"></i> by Devansh shah</a>
