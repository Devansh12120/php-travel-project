...
<body id="home" class="scrollspy">
  ...
  <section class="slider">
    <ul class="slides">
      <li>
        <img src="http://wallpapers-best.com/uploads/posts/2016-01/14_bus.jpg">
        <!-- random image -->
      ...
      <li>
        <img src="https://images.hdqwalls.com/download/bus-journey-scenery-4k-lv-1920x1080.jpg">
        <!-- random image -->
      ...
      <li>
        <img src="https://www.holidify.com/images/cmsuploads/compressed/bus-on-road-moving-towards-mountains-wallpaper-preview_20200227123401.jpg">
        <!-- random image -->
  ...
  <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            $query = mysqli_query($con, "SELECT * FROM `buss`");
            if ($query->num_rows > 0) {
                # code...
            }
                ...
                <td>".$air["class"]."</td>
                <td>".$air["Travelling_time"]."</td>
				<td>" ?><a href="bus.php"><button class="fly" onclick="return payment()" ><i class="fa fa-bus" aria-hidden="true"></i></button></a><?php "</td>
            </tr>";
