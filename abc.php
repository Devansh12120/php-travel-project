...
<body id="home" class="scrollspy">
  ...
  <section class="slider">
    <ul class="slides">
      ...
      <li>
        <img src="https://wallpapercave.com/wp/wp3779111.jpg">
        <!-- random image -->
  ...
  <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            if ($query->num_rows > 0) {
                ...
                <td>".$air["amount"]."</td>
				<td>" ?><a href="payment.php"><button class="fly" onclick="return payment()" ><i class="fa fa-bus" aria-hidden="true"></i></button></a><?php "</td>
            </tr>";
