                    ...
                    ?>
					    <div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="hotel-single.php" class="img img-2 d-flex justify-content-center align-items-center">
								<?php echo '<img src="data:image;base64,'.base64_encode($row['image']).'" alt="" style="height:250px; width:250px">' ?>
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="hotel-single.php"><?php echo $row['name']; ?></a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
		    						...
		    						<p class="bottom-area d-flex">
		    							<span><i class="icon-map-o"></i><?php echo $row['nameplace']; ?></span> 
